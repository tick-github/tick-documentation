...
| A dockerized Java Spring Cloud implementation, a continuation of [this](docs/proof/3-poc-java-customer-service.md) POC. | Proof of Concept | N/A | [🔗](docs/proof/4-poc-dockerized-java-customer-services.md) |
